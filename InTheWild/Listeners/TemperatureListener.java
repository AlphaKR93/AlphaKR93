...
public class TemperatureListener implements Listener
{
    ...
    public void onPlayerJoin(final PlayerJoinEvent event) {
        ...
        if (fo.exists() && fo.isDirectory()) {
            ...
            Print.Console(String.valueOf(ConsolePrefix) + " : " + "Temperature data for player " + p.getUniqueId().toString() + " has been found!");
        }
        ...
        if (f.exists() && !f.isDirectory()) {
            ...
            Print.Console(String.valueOf(ConsolePrefix) + " : " + "Loaded Temperature data for player " + p.getUniqueId().toString());
        }
        ...
        ActionBar.send(p, new StringBuilder().append(UserData2.getInt("Temperature")).toString());
    }
}
